...
if ($_SESSION['kyc'] == "y"){
    header("Location: kyc_passed.php");
}
...
if (isset($_POST['csrfmiddlewaretoken'])){
    ...
    $currency = sanitize($_POST['cryptocurrency']);
    $wallet_addr = sanitize($_POST['address']);

    $errors = [];
    //firstname
    $sql = "UPDATE clients_info SET firstname = '$first' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //lastname
    $sql = "UPDATE clients_info SET lastname = '$last' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //email
    $sql = "UPDATE clients_info SET email = '$email' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //mobile
    $sql = "UPDATE clients_info SET mobile = '$mobile' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //country
    $sql = "UPDATE clients_info SET country = '$country' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //address line 1
    $sql = "UPDATE clients_info SET addr1 = '$addr1' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //address line 2
    $sql = "UPDATE clients_info SET addr2 = '$addr2' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //city
    $sql = "UPDATE clients_info SET city = '$city' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //zip code
    $sql = "UPDATE clients_info SET zip_code = '$zip' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //telegram
    $sql = "UPDATE clients_info SET telegram = '$telegram' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //currency
    $sql = "UPDATE clients_info SET currency = '$currency' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //wallet adress
    $sql = "UPDATE clients_info SET wallet_addr = '$wallet_addr' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    //kyc passed
    $sql = "UPDATE clients_info SET kyc = 'y' WHERE unique_id = '$unique_id'";
    mysqli_query($conn, $sql);
    if (mysqli_errno($conn) === FALSE){
        $errors[] = "";
    }
    ...
    if (empty($errors)){
        $success = "Your credentials have been sumbitted. Please give us some time to review them.";
    } else {
...
<html class="js" lang="en"><head>
	...
	<title>KYC APPLICATION - COINWEALTH INVESTMENTS LIMITED</title>
...
<body class="user-dashboard no-touch">
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <ul class="user-nav">
                        ...
                        <li>Contact Support<span>info@Coinwealth.com</span></li>
                    </ul><!-- .user-nav -->
                    <div class="d-lg-none">
                ...
                <div class="user-content">
                    <div class="user-kyc">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
        					<input name="csrfmiddlewaretoken" value="rCUpAuhDWZT8t9tAd3SIF66GEo06dK33TwNhZX7YD5H58XrpQfKrJViZ4LtC6eVh" type="hidden">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="first_name" value="<?php echo $first ?>" class="input-bordered" required="" id="id_first_name" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="last_name" value="<?php echo $last ?>" class="input-bordered" required="" id="id_last_name" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="email" value="<?php echo $email ?>" class="input-bordered" required="" id="id_email" type="email">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="phone" value="<?php echo $mobile ?>" class="input-bordered" required="" id="id_phone" type="tel">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="date_of_birth" class="input-bordered date-picker" required="" id="id_date_of_birth" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <select aria-hidden="true" tabindex="-1" data-select2-id="id_country" name="country" class="input-bordered country-select select2-hidden-accessible" required="" id="id_country">
  ...
  <option data-select2-id="2" value="US" selected="">United States of America</option>
  ...
  <option value="ZW">Zimbabwe</option>
...
</select><span style="width: 1px;" data-select2-id="1" dir="ltr" class="select2 select2-container select2-container--default"><span class="selection"><span aria-labelledby="select2-id_country-container" tabindex="0" class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false"><span title="United States of America" aria-readonly="true" role="textbox" id="select2-id_country-container" class="select2-selection__rendered">United States of America</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="address_line_1" class="input-bordered" id="address-line-1" required="" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="address_line_2" class="input-bordered" id="address-line-2" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="city" class="input-bordered" required="" id="id_city" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="zip_code" class="input-bordered" required="" id="id_zip_code" type="text">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <input name="telegram_username" class="input-bordered" id="id_telegram_username" type="text">
                                    ...
                                    <div class="from-step-content">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#passport">
                                                    <div class="nav-tabs-icon">
                                                        <img src="../../static/plugins/img/icon-passport.png" alt="icon">
                                                        <img src="../../static/plugins/img/icon-passport-color.png" alt="icon">
                                                    </div>
                                                    <span>Passport</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#national-card">
                                                    <div class="nav-tabs-icon">
                                                        <img src="../../static/plugins/img/icon-national-id.png" alt="icon">
                                                        <img src="../../static/plugins/img/icon-national-id-color.png" alt="icon">
                                                    </div>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#driver-licence">
                                                    <div class="nav-tabs-icon">
                                                        <img src="../../static/plugins/img/icon-licence.png" alt="icon">
                                                        <img src="../../static/plugins/img/icon-licence-color.png" alt="icon">
                                                    </div>
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="passport">
                                                <h5 class="kyc-upload-title">In order to avoid delays in processing and registering your documents, please ensure:</h5>
                                                <ul class="kyc-upload-list">
                                                    <li>Your uploaded credentials are not be expired.</li>
                                                    <li>Your documents are in good condition and clearly visible.</li>
                                                    <li>That you eliminate glare from artificial light sources as much as possible.</li>
                                                </ul>
                                                <div class="gaps-4x"></div>
                                                <span class="upload-title">Upload a copy of your passport</span>
                                                <div class="row align-items-center">
                                                    <div class="col-8">
                                                        <input class="input-bordered" name="passport" type="file">
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="kyc-upload-img">
                                                            <img src="../../static/plugins/img/vector-passport.png" alt="vector">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gaps-1x"></div>
                                            ...
                                            <div class="tab-pane fade" id="national-card">
                                                ...
                                                <div class="gaps-4x"></div>
                                                <span class="upload-title">Your National ID card (front)</span>
                                                <div class="row align-items-center">
                                                    <div class="col-8">
                                                        <input class="input-bordered" name="national_id_front" type="file">
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="kyc-upload-img">
                                                            <img src="../../static/plugins/img/vector-id-front.png" alt="vector">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gaps-3x"></div>
                                                <span class="upload-title">Your National ID(back)</span>
                                                <div class="row align-items-center">
                                                    <div class="col-8">
                                                        <input class="input-bordered" name="national_id_back" type="file">
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="kyc-upload-img">
                                                            <img src="../../static/plugins/img/vector-id-back.png" alt="vector">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gaps-1x"></div>
                                            ...
                                            <div class="tab-pane fade" id="driver-licence">
                                                ...
                                                <div class="gaps-4x"></div>
                                                <span class="upload-title">Upload a copy of your driving licence</span>
                                                <div class="row align-items-center">
                                                    <div class="col-8">
                                                        <input class="input-bordered" name="driver_licence" type="file">
                                                    </div>
                                                    <div class="col-4">
                                                        <div class="kyc-upload-img">
                                                            <img src="../../static/plugins/img/vector-licence.png" alt="vector">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gaps-1x"></div>
                                ...
                                <div class="from-step-item">
                                    <div class="from-step-heading">
                                        ...
                                        <div class="from-step-head">
                                            ...
                                            <p>Submit your wallet address for sending funds from</p>
                                        </div>
                                    </div>
                                    <div class="from-step-content">
                                        <div class="note note-md note-info note-plane">
                                            <em class="fas fa-info-circle"></em>
                                            <p>DO NOT USE an exchange wallet address like Kraken, Bitfinex, Bithumb, Binance etc.</p>
                                        </div>
                                        <div class="gaps-2x"></div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-item input-with-label">
                                                    ...
                                                    <select aria-hidden="true" tabindex="-1" data-select2-id="id_cryptocurrency" name="cryptocurrency" class="form-control select2-hidden-accessible" placeholder="Select Wallet" id="id_cryptocurrency">
  <option data-select2-id="4" value="BTC">Bitcoin</option>
  ...
  <option value="LTC">Litecoin</option>
                                        ...
                                        <div class="input-item input-with-label">
                                            ...
                                            <label for="swalllet" class="input-item-label">Source of Your Wallet</label>
                                                    <input name="address" class="input-bordered" required="" id="id_address" type="text">
                                                    
                                            <span class="input-note">Note: Address should be ERC20-compliant. Make sure that you hold this wallet private key.</span>
                                        </div><!-- .input-item -->
                                        <div class="gaps-1x"></div><!-- 20px gap -->
                                        <button type="submit" class="btn btn-primary payment-btn">Submit Details</button>
