...
<html lang="en" class="js"><head>
	...
	<title>TRANSACTIONS - COINWEALTH INVESTMENTS LIMITED</title>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="user-dropdown">
                                <div class="user-dropdown-head">
                                    <h6 class="user-dropdown-name">Icheka Ozuru <span>(Icheka)</span></h6>
                                    <span class="user-dropdown-email">rhemafortune@gmail.com</span>
                                </div>
            ...
            <div class="d-flex">
                <div class="user-sidebar user-sidebar-mobile">
                    ...
                    <div class="user-box d-none d-lg-block">
                        ...
                        <h6 class="user-name">Icheka Ozuru</h6>
                        <div class="user-uid">username: <span>Icheka</span></div>
                    ...
                    <ul class="user-icon-nav">
                        ...
                        <li class="active"><a href="../transactions/"><em class="ti ti-control-shuffle"></em>Transactions</a></li>
                ...
                <div class="user-content">
                    <div class="user-panel">
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#withdrawals">Withdrawals</a>
                            </li>
                        </ul><!-- .nav-tabs-line -->
                        ...
                        <div class="tab-content" id="security-opt-tab">
                            ...
                            <div class="tab-pane fade active show" id="deposits">
                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-10 text-left"><div id="DataTables_Table_0_filter" class="dataTables_filter"><label><input type="search" class="form-control form-control-sm" placeholder="Type in to Search" aria-controls="DataTables_Table_0"></label></div></div><div class="col-2 text-right"><div class="data-table-filter dropdown"><a href="#" data-toggle="dropdown"><em class="ti ti-settings"></em></a><ul class="dropdown-menu dropdown-menu-right"><li><input class="data-filter data-filter-approved" type="radio" name="filter" id="all" checked="" value=""><label for="all">All</label></li><li><input class="data-filter data-filter-approved" type="radio" name="filter" id="approved" value="approved"><label for="approved">Approved</label></li><li><input class="data-filter data-filter-pending" type="radio" name="filter" value="pending" id="pending"><label for="pending">Pending</label></li><li><input class="data-filter data-filter-cancled" type="radio" name="filter" value="cancled" id="cancled"><label for="cancled">Cancled</label></li></ul></div></div></div><div class="row"><div class="col-12"><div class="overflow-x-auto"><table class="data-table tranx-table dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                        <tr role="row"><th class="tranx-status sorting_disabled" rowspan="1" colspan="1"></th><th class="tranx-no sorting_disabled" rowspan="1" colspan="1"><span>amount</span></th><th class="tranx-token sorting_disabled" rowspan="1" colspan="1"><span>plan</span></th><th class="tranx-amount sorting_disabled" rowspan="1" colspan="1"><span>payment mode</span></th><th class="tranx-from sorting_disabled" rowspan="1" colspan="1"><span>date</span></th></tr>
                                    </thead>
                                    <tbody>
                                        
                                    <tr class="odd"><td valign="top" colspan="5" class="dataTables_empty">No data available in table</td></tr></tbody>
                                </table></div></div></div><div class="row"><div class="col-sm-6 text-left"></div><div class="col-sm-6 text-sm-right"><div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">No records</div></div></div></div>
                            </div><!-- .tab-pane -->
<!-- =================================================================================================================================== -->
                            <div class="tab-pane fade" id="withdrawals">

                                <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-10 text-left"><div id="DataTables_Table_1_filter" class="dataTables_filter"><label><input type="search" class="form-control form-control-sm" placeholder="Type in to Search" aria-controls="DataTables_Table_1"></label></div></div><div class="col-2 text-right"><div class="data-table-filter dropdown"><a href="#" data-toggle="dropdown"><em class="ti ti-settings"></em></a><ul class="dropdown-menu dropdown-menu-right"><li><input class="data-filter data-filter-approved" type="radio" name="filter" id="all" checked="" value=""><label for="all">All</label></li><li><input class="data-filter data-filter-approved" type="radio" name="filter" id="approved" value="approved"><label for="approved">Approved</label></li><li><input class="data-filter data-filter-pending" type="radio" name="filter" value="pending" id="pending"><label for="pending">Pending</label></li><li><input class="data-filter data-filter-cancled" type="radio" name="filter" value="cancled" id="cancled"><label for="cancled">Cancled</label></li></ul></div></div></div><div class="row"><div class="col-12"><div class="overflow-x-auto"><table class="data-table tranx-table dataTable no-footer" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                                    <thead>
                                        <tr role="row"><th class="tranx-status sorting_disabled" rowspan="1" colspan="1"></th><th class="tranx-no sorting_disabled" rowspan="1" colspan="1"><span>amount</span></th><th class="tranx-token sorting_disabled" rowspan="1" colspan="1"><span>payout mode</span></th><th class="tranx-action sorting_disabled" rowspan="1" colspan="1">type</th><th class="tranx-amount sorting_disabled" rowspan="1" colspan="1"><span>Address</span></th><th class="tranx-from sorting_disabled" rowspan="1" colspan="1"><span>date</span></th></tr>
                                    </thead>
                                    <tbody>
                                        
                                    <tr class="odd"><td valign="top" colspan="6" class="dataTables_empty">No data available in table</td></tr></tbody>
                                </table></div></div></div><div class="row"><div class="col-sm-6 text-left"></div><div class="col-sm-6 text-sm-right"><div class="dataTables_info" id="DataTables_Table_1_info" role="status" aria-live="polite">No records</div></div></div></div>
                            </div><!-- .tab-pane -->
                        </div><!-- .tab-content -->
