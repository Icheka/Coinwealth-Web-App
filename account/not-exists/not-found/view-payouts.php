...
if (isset($_POST['csrfmiddlewaretoken'])){
    ...
    * INVESTMENTS
    ...
    $info .= "<th>Date</th><th>Amount (crypto)</th>";

    $sql = "SELECT * FROM withdrawals";
    $resource = mysqli_query($conn, $sql);
    while ($row = mysqli_fetch_array($resource, MYSQLI_ASSOC)){
        $info .= "<tr> <td> $row[unique_id] </td> <td> $row[withdrawal_amount] </td> <td> $row[currency] </td> <td> $row[withdrawal_date] </td> <td> $row[currency_amount] </td> </tr>";
    }
    $info .= "</table>";
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <ul class="user-icon-nav">
                        ...
                        <li class="active"><a href="view-payouts.php"><em class="ti ti-wallet"></em>View All Payouts</a></li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <input type="hidden" name="<?php echo 'csrfmiddlewaretoken'?>" value="<?php echo 'I1ix3es7W5snVjVbvLNvXPdr0Tmqlb5t7bzmtaRbJAtDHM02QfZxNi68Sv6Iejju' ?>">
                                        <center>
                                            <button id="submit" type="submit" class="btn btn-warning mt-3">DISPLAY PAYOUTS</button>
                                        </center>
