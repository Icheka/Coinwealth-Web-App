...
if (isset($_POST['csrfmiddlewaretoken'])){
    ...
    * INVESTMENTS
    ...
    $info .= "<th>ID</th><th>Amount (USD)</th><th>Currency</th>";
    $info .= "<th>Plan</th><th>Cashed</th><th>Date</th></tr></thead>";

    $sql = "SELECT * FROM investments";
    $resource = mysqli_query($conn, $sql);
    while ($row = mysqli_fetch_array($resource, MYSQLI_ASSOC)){
        $info .= "<tr> <td> $row[unique_id] </td> <td> $row[deposit_amount] </td> <td> $row[currency] </td> <td> $row[deposit_plan] </td> <td> $row[cashed] </td> <td> $row[deposit_date] </td> </tr>";
    }
    $info .= "</table>";
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <ul class="user-icon-nav">
                        ...
                        <li class="active"><a href="all-investments.php"><em class="ti ti-wallet"></em>View All Investments</a></li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12">
                                    ...
                                    <input type="hidden" name="<?php echo 'csrfmiddlewaretoken'?>" value="<?php echo 'I1ix3es7W5snVjVbvLNvXPdr0Tmqlb5t7bzmtaRbJAtDHM02QfZxNi68Sv6Iejju' ?>">
                                        <center>
                                            <button id="submit" type="submit" class="btn btn-warning mt-3">DISPLAY INVESTMENTS</button>
                                        </center>
