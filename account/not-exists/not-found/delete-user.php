...
if (isset($_POST['csrfmiddlewaretoken'])){
    ...
    $sql = "DELETE FROM clients_info WHERE unique_id = '$id'";
    $result = mysqli_query($conn, $sql);
    $info = "User with former ID " . $id . " deleted successfully. This action cannot be undone.";
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <ul class="user-icon-nav">
                        ...
                        <li class="active"><a href="delete-user.php"><em class="ti ti-id-badge"></em>Delete User</a></li>
                    ...
                    <div class="user-panel">
                        ...
                        <div class="info-card info-card-bordered">
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <!-- FORM -->
                                    <form id="form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="admin" style="
                                    <?php 
                                    ...
                                    <input type="hidden" name="<?php echo 'csrfmiddlewaretoken'?>" value="<?php echo 'I1ix3es7W5snVjVbvLNvXPdr0Tmqlb5t7bzmtaRbJAtDHM02QfZxNi68Sv6Iejju' ?>">
                                        ...
                                        <center>
                                            <button id="submit" type="submit" class="btn btn-danger mt-3">DELETE USER!</button>
                                        </center>
                                    ...
                                    <script>
                                        document.getElementById("form").onsubmit = () => {
                                            if (confirm("Do you really want to delete that user?") === true){
                                                return true;
                                            } else {
                                                return false;
                                            }
