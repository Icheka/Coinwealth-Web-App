                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="user-dropdown">
                                <div class="user-dropdown-head">
                                    <h6 class="user-dropdown-name"><span><?php echo $first." ".$last ?></span> <span><?php echo $first ?></span></h6>
                                ...
                                <ul class="user-dropdown-links">
                                    <li><a href="reset-password.php"><i class="ti ti-lock"></i>Reset Password</a></li>
            ...
            <div class="d-flex">
                <div class="user-sidebar">
                    ...
                    <ul class="user-icon-nav">
                        ...
                        <li><a href="view-investments.php"><em class="ti ti-wallet"></em>View All Investments</a></li>
                        ...
                        <li><a href="reset-password.php"><em class="ti ti-lock"></em>Reset Password</a></li>
